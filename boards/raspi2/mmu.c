...
__attribute__ ((aligned(L1_TABLE_SIZE))) uint32_t entry_l1_table[L1_TABLE_SIZE] = {
    ...
    // gpio (for uart)
    [L1_IDX(0x3F200000)] = (0x3F200000) | L1_SECT_PRIVILEGED_RW | L1_SECT_MEM_DEVICE | L1_TYPE_SECT,

    // local peripherals (timer irq)
    [L1_IDX(0x40000000)] = (0x40000000) | L1_SECT_PRIVILEGED_RW | L1_SECT_MEM_DEVICE | L1_TYPE_SECT,
};
...
void insert_kernel_mapping_into_table(uint32_t *l1_table)
{
    ...
    // gpio (for uart)
    l1_table[L1_IDX((0x3F200000))] = (0x3F200000) | L1_SECT_PRIVILEGED_RW | L1_SECT_MEM_DEVICE | L1_TYPE_SECT;

    // local peripherals (timer irq)
    l1_table[L1_IDX(0x40000000)] = (0x40000000) | L1_SECT_PRIVILEGED_RW | L1_SECT_MEM_DEVICE | L1_TYPE_SECT;
