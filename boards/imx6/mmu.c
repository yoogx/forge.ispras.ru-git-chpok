...
__attribute__ ((aligned(L1_TABLE_SIZE))) uint32_t entry_l1_table[L1_TABLE_SIZE] = {
    ...
    // uart
    [L1_IDX(VIRT_IO(0x2020000))] = (0x2020000) | L1_SECT_PRIVILEGED_RW | L1_SECT_MEM_DEVICE | L1_TYPE_SECT,

    // scu
    [L1_IDX(VIRT_IO(0xa00000))] = (0xa00000) | L1_SECT_PRIVILEGED_RW | L1_SECT_MEM_DEVICE | L1_TYPE_SECT,
};
...
void insert_kernel_mapping_into_table(uint32_t *l1_table)
{
    ...
    // uart
    l1_table[L1_IDX(VIRT_IO(0x2020000))] = (0x2020000) | L1_SECT_PRIVILEGED_RW | L1_SECT_MEM_DEVICE | L1_TYPE_SECT;

    // scu
    l1_table[L1_IDX(VIRT_IO(0xa00000))] = (0xa00000) | L1_SECT_PRIVILEGED_RW | L1_SECT_MEM_DEVICE | L1_TYPE_SECT;
}
