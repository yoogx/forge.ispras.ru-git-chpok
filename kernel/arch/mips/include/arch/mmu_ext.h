...
#define EntryLo0_PFN(x)         ((x >> 13) << 6)    /*Номер четной страницы. Соответствует битам [35..12] физического адреса*/
...
#define EntryLo1_PFN(x)         ((x >> 13) << 6)    /*Номер нечетной страницы. Соответствует битам [35..12] физического адреса*/
#define EntryLo1_PS(x)          (((x >> 13) + 0x1) << 13)/*Добавка к нечетной физ. странице, зависящая от размера страницы*/
